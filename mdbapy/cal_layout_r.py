...
def radial_stagger(latitude, num_hst, width, height, hst_z, towerheight, R1, delta_r_g, dsep=0., field='polar', savedir='.', plot=False):
	...
	while num<num_hst:
		...
		if i>1:
			Nrows=int(Nrows*10.0)   # only three zones
		Nhel=(2**(i))*Nhel1
		R=Nhel/2./np.pi*DM
...
if __name__=='__main__':
	...
	pos_and_aim=radial_stagger(latitude=34.85, num_hst=10500, width=12.2, height=12.2, hst_z=7., towerheight=187., R1=0.75*187.,delta_r_g=[0.866,1.0,1.5], dsep=0., field='surround', savedir='.', plot=True)
